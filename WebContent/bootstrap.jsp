...
%>
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="uploadcsv.jsp">Menu</a></li>
                            <li><a href="point.jsp">Wallet</a></li>
                            <li><a href="changepassword.jsp">Change Password</a></li>
                            <li><a href="vd.jsp">ORDERS</a></li>
                ...
                <div class="col-md-3 col-xs-6">
                    <ul class="plan plan1">
                        ...
                        <li class="plan-price">
                          ...
                          <li>  <%out.println("&nbsp;");
                        		out.println("<input type='submit' name='cb'  value="+rs.getString(1)+" />"); %>
                        </li>
                        </li>
